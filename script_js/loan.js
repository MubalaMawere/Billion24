document.addEventListener("DOMContentLoaded", function () {
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbyrrfJzC44C4pPgDQPFh-Cweay3hKrJA7RdA5xmAS7ExOBzX77s1hQcycB6_JK0wPnN4w/exec";
  ...
  form.addEventListener("submit", function (e) {
    ...
    submitStepBtn.textContent = "Submitting...";
    ...
    fetch(scriptURL, {
      ...
      .finally(() => {
        ...
        submitStepBtn.textContent = "Submit Application";
      });
  });
});